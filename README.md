...
<!--
**Saleh-Mohammed-Alabidi/Saleh-Mohammed-Alabidi** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
<h1 align="center">👋 Hi, I'm Saleh Al-Abidi</h1>

<p align="center">
  🔧 Full Stack Developer | ASP.NET | Node.js | React | Vue | Microservices | Docker  
</p>
...
- ⚙️ Backend: **ASP.NET**, **Node.js**, **Microservices**, **DDD**, **Clean Architecture**, **Docker**  
- 🎨 Frontend: **React**, **Next.js**, **Vue.js**, **Nuxt.js**  
- 🧪 I write clean, maintainable code with strong testing practices  
...
<table>
  <tr>
    ...
    <td align="center" width="100">
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original.svg" width="40" /><br>Vue.js
    </td>
    <td align="center" width="100">
